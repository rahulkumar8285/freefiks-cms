                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <form id="formSubmit" method="POST" action="{{ route('users.update', $user->id) }}">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" class="form-control" name="email" id="email" value="{{ $user->email }}" placeholder="Enter your email">
                                                <span class="invalid-feedback"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="phone" id="phone" value="{{ $user->phone }}" placeholder="Enter your phone number">
                                                <span class="invalid-feedback"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
